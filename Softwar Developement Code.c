...
void initialize_scoreboard(char team1_players[MAX_PLAYERS][50], char team2_players[MAX_PLAYERS][50])
{
    ...
    display_initial_scoreboard(team1_name, team2_name, batting_team, 0, 0, 0, 0.0, (batting_team == 0) ? team1_players : team2_players, (int[2]){0, 1});
}
        ...
        for (int ball = 1; ball <= 6; ball++)
        {
            ...
            case 4:
            {
                ...
                if (valid_wicket == 'y')
                {
                    ...
                    if (falls_of_wicket == 2)
                    {
                        printf(R"EOF(
                         _   _      _      _____           _____   ____    ___    ____   _  __
                        | | | |    / \    |_   _|         |_   _| |  _ \  |_ _|  / ___| | |/ /
                        | |_| |   / _ \     | |    _____    | |   | |_) |  | |  | |     | ' /
                        |  _  |  / ___ \    | |   |_____|   | |   |  _ <   | |  | |___  | . \
                        |_|_|_|_/_/_ _\_\_ _|_|_ _____ _____|_|___|_|_\_\_|___|__\____|_|_|\_\__
                        |_____|_____|_____|_____|_____|_____|_____|_____|_____|_____|_____|_____|
                        | __ )             / \               | |                | |
                        |  _ \   _____    / _ \    _____     | |      _____     | |
                        | |_) | |_____|  / ___ \  |_____|    | |___  |_____|    | |___
                        |____/          /_/   \_\            |_____|            |_____|          )EOF");
                        printf("\n");
                    }
                    if (falls_of_wicket == 3)
                    {
                        printf("A SENSATOINAL PLAY BY THE BOWLER...\n");
                    }
                    if (valid_wicket == 'n')
                    {
                        printf(R"EOF(
